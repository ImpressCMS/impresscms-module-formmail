...
/* nine stars add */
define("_AM_FORM_ADMENU","SPAM対策");
define("_AM_FORM_ATTESTATION_CODE","認証コード");
define("_AM_FORM_ATTESTATION_MESSAGE","確認のため認証コードを入力してください。");
define("_AM_FORM_ATTESTATION_ERROR","認証コードが一致しませんでした。お手数ですがもう一度ご入力ください。");
define("_AM_FORM_TITLE0","SPAM対策");
define("_AM_FORM_TITLE1","文字数");
define("_AM_FORM_TITLE2","文字をゆがめる");
define("_AM_FORM_TITLE3","認証画像に線を引く");
define("_AM_FORM_TITLE4","fontファイル名");
define("_AM_FORM_TITLE5","SSL対応");
define("_AM_FORM_TITLE6","SSLプロトコル");
define("_AM_FORM_TITLE7","SSL環境変数");
define("_AM_FORM_BTN1","保存");
define("_AM_FORM_BTN2","リセット");
define("_AM_FORM_ON","○");
define("_AM_FORM_OFF","×");

define("_AM_FORM_CAPTCHA_TITLE","画像認証（スパム対策）");
define("_AM_FORM_CAPTCH_DESC","表示されている文字列を入力してください。<br />読みにくいときは、画像をクリックすると、別の文字列が表示されます。");
