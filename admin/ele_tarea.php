...
$rows = new XoopsFormText(_AM_FORM_ELE_ROWS, 'ele_value[1]', 3, 3, $rows);
$cols = new XoopsFormText(_AM_FORM_ELE_COLS, 'ele_value[2]', 3, 3, $cols);
$default = new XoopsFormTextArea(_AM_FORM_ELE_DEFAULT, 'ele_value[0]', $value[0], 5, 35);
