...
$size = new XoopsFormText(_AM_FORM_ELE_SIZE, 'ele_value[0]', 3, 2, $ele_size);
$allow_multi = empty($ele_value[1]) ? 0 : 1;
$multiple = new XoopsFormRadioYN(_AM_FORM_ELE_MULTIPLE, 'ele_value[1]', $allow_multi);
...
$opt_tray->setDescription(_AM_FORM_ELE_OPT_DESC._AM_FORM_ELE_OPT_DESC1);
