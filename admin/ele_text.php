...
$size = new XoopsFormText(_AM_FORM_ELE_SIZE, 'ele_value[0]', 3, 3, $size);
$max = new XoopsFormText(_AM_FORM_ELE_MAX_LENGTH, 'ele_value[1]', 3, 3, $max);
$default = new XoopsFormText(_AM_FORM_ELE_DEFAULT, 'ele_value[2]', 50, 255, $value[2]);
$default->setDescription(_AM_FORM_ELE_TEXT_DESC);
