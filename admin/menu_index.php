...
function MyMenuSave($menuid, $xposition, $itemname, $indent, $margintop, $marginbottom, $itemurl, $bold, $membersonly, $mainmenu, $status) 
{
	...
	$xoopsDB->query("UPDATE ".$xoopsDB->prefix("formmail_menu")." SET position=$xposition, itemname='$itemname', indent='$indent', margintop='$margintop', marginbottom='$marginbottom', itemurl='$itemurl', bold=$bold, membersonly=$membersonly, mainmenu=$mainmenu, status=$status WHERE menuid=$menuid");
...
//	$xoopsDB->query("INSERT INTO ".$xoopsDB->prefix("formmail_menu")." (menuid, position, itemname, indent, margintop, marginbottom, itemurl, bold, membersonly, mainmenu, status) VALUES ($newid, $xposition, '$itemname', '$indent', '$margintop', '$marginbottom', '$itemurl', $bold, $membersonly, $mainmenu, $status)");
	$sql = sprintf("INSERT INTO ".$xoopsDB->prefix("formmail_menu")." ( position, indent, itemname, margintop, marginbottom, itemurl, bold, mainmenu, membersonly, status) VALUES ('$xposition', '$indent', '$itemname', '$margintop', '$marginbottom', '$itemurl', $bold, $mainmenu, $membersonly, $status)");
	$xoopsDB->query($sql);
	redirect_header("menu_index.php?op=MyMenuAdmin",1,_AM_FORM_DBUPDATED);
	exit();
}
